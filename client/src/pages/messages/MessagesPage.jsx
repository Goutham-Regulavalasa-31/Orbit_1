...
const MessagesPage = () => {
  ...
  return (
    <div className="flex h-full min-h-0 flex-1">
      ...
      <div
        className={`w-full shrink-0 flex-col border-border sm:w-80 sm:border-r ${
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-2 py-2">
          ...
          {isError && !isLoading && (
            <div className="flex flex-col items-center gap-2 py-10 text-center">
              ...
              <button
                onClick={refetch}
                className="flex items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-[11px] font-medium hover:bg-muted"
              >
      ...
      <div className={`min-h-0 flex-1 flex-col ${selectedUserId ? "flex" : "hidden sm:flex"}`}>
        {selectedUserId ? (
          <>
            <Link
              to="/messages"
              className="flex items-center gap-1.5 border-b border-border px-4 py-2 text-xs font-medium text-muted-foreground hover:text-foreground sm:hidden"
            >
